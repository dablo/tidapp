...
define('tid-rapport',['exports', 'aurelia-event-aggregator', './web-api', './messages', './utility', './tidrapport', 'clipboard'], function (exports, _aureliaEventAggregator, _webApi, _messages, _utility, _tidrapport, _clipboard) {
  ...
  var ContactDetail = exports.ContactDetail = (_temp = _class = function () {
    ...
    ContactDetail.prototype.addForaldraledighetsdag = function addForaldraledighetsdag() {
      this.tidrapport.addForaldraledighet(new _tidrapport.Dag(this.nyDag.dag));
      this.uppdateraRapport();
    };

    ContactDetail.prototype.removeForaldraledighetsdag = function removeForaldraledighetsdag(dag) {
...
define('tidrapport',['exports'], function (exports) {
    ...
    var Tidrapport = exports.Tidrapport = function () {
        ...
        Tidrapport.prototype.addForaldraledighet = function addForaldraledighet(dag) {
            this.foraldraledighetsDagar.push(dag);
        };

        Tidrapport.prototype.removeForaldraledighet = function removeForaldraledighet(dag) {
            var index = this.foraldraledighetsDagar.findIndex(dag);
            if (index !== -1) this.foraldraledighetsDagar.splice(dag);
        };
        ...
        Tidrapport.prototype.format = function format() {
            ...
            rapport += '\nFöräldraledighet\n';
            this.foraldraledighetsDagar.forEach(function (dag) {
                rapport += dag.format() + '\n';
            });
